...
import static com.darwinreforged.pweather.LightningManager.determineLightningPosition;
    ...
    if (packetGateOptional.isPresent()) {
      ...
      if (optionalConnection.isPresent())
      {
        ...
        switch (weather)
        {
          ...
          case LIGHTNING:
            Optional<Vector3d> optionalLightningPosition = determineLightningPosition(uuid);
